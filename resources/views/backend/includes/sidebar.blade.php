<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('banners.index') }}" data-toggle="collapse" data-target="#collapseOne"
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('banners.index') }}">All banners</a>

                <a class="collapse-item" href="{{ route('banners.create') }}">Create banner</a>
            </div>
        </div>
    </li>

    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('categories.index') }}" data-toggle="collapse" data-target="#collapseTwo"
           aria-expanded="true" aria-controls="collapseTwo">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('brands.index') }}" data-toggle="collapse" data-target="#collapseThree"
           aria-expanded="true" aria-controls="collapseTwo">
            <span>Brands({{ \App\Models\Brand::count() }})</span>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('products.index') }}" data-toggle="collapse" data-target="#collapseFour"
           aria-expanded="true" aria-controls="collapseTwo">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('vendors.index') }}" data-toggle="collapse" data-target="#collapseFive"
           aria-expanded="true" aria-controls="collapseTwo">
            <span>Vendors({{ \App\Models\Vendor::count() }})</span>
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Vendors Management</h6>

                <a class="collapse-item" href="{{ route('vendors.index') }}">All vendors</a>
