<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('brands.index') }}" data-toggle="collapse" data-target="#collapseSix"
           aria-expanded="true" aria-controls="collapseTwo">
            <span>Coupons({{ \App\Models\Coupon::count() }})</span>
        ...
        <div id="collapseSix" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('coupons.index') }}">All coupons</a>

                <a class="collapse-item" href="{{ route('coupons.create') }}">Create coupon</a>
            </div>
        </div>
    </li>
